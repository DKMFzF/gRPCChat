...
class ChatDto extends $pb.GeneratedMessage {
  factory ChatDto({
    ...
    $core.String? name,
    $core.String? author,
    $core.Iterable<MessageDto>? message,
  }) {
    final $result = create();
    if (id != null) {
      $result.id = id;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ChatDto', createEmptyInstance: create)
    ...
    ..pc<MessageDto>(4, _omitFieldNames ? '' : 'message', $pb.PbFieldType.PM, subBuilder: MessageDto.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $core.List<MessageDto> get message => $_getList(3);
}
