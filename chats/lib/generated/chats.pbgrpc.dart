...
class ChatsRpcClient extends $grpc.Client {
  ...
  static final _$deleteChat = $grpc.ClientMethod<$0.ChatDto, $0.ResponseDto>(
      ...
      ($0.ChatDto value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.ResponseDto.fromBuffer(value));
  static final _$fetchChats = $grpc.ClientMethod<$0.ChatDto, $0.ChatDto>(
      '/ChatsRpc/FetchChats',
      ($0.ChatDto value) => value.writeToBuffer(),
  ...
  $grpc.ResponseFuture<$0.ChatDto> fetchChats($0.ChatDto request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$fetchChats, request, options: options);
  }
...
abstract class ChatsRpcServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.ChatDto> fetchChats_Pre($grpc.ServiceCall call, $async.Future<$0.ChatDto> request) async {
    return fetchChats(call, await request);
  }
  ...
  $async.Future<$0.ChatDto> fetchChats($grpc.ServiceCall call, $0.ChatDto request);
